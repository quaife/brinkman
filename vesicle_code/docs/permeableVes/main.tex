...
\begin{figure*}[htp]
  ...
  \includegraphics[width=\linewidth]{figures/ellipseArea}
  \end{minipage}
  \hfill
  \begin{minipage}{0.56\textwidth}
  \includegraphics[width=0.31\linewidth]{figures/ellipseVelocity1.pdf}
  \includegraphics[width=0.31\linewidth]{figures/ellipseVelocity2.pdf}
  \includegraphics[width=0.31\linewidth]{figures/ellipseVelocity3.pdf}
  \end{minipage}
  \caption{A big caption for a composite figure}
\end{figure*}
