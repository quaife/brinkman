...
extensional flow are available in the literature \todo[inline]{Something
is off with this sentence}.  In the following we first illustrate how
...
%   \includegraphics[width=0.25\textwidth]{figs/rotate2.pdf}
   ...
   \todo[inline]{What do you think about reversing (a) and (b)?}
 \end{figure}
...
be similar between two-~\cite{LacMorelBarthes-Biesel2007_JFM,
RahimianVeerapaneniBiros2010_JCP} and
three-dimensions~\cite{LacBarthes-Biesel2008_PoF,
