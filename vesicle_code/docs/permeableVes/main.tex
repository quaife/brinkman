...
water molecules. As long as the bilayer structure stays intact
without poration or rupture under load, the water influx/efflux is
often assumed to be negligible in the absence of a gradient of osmotic
stress. In this work we use boundary integral simulations to
investigate the effects of water permeability on the hydrodynamics of
a vesicle under various flows and confinement configurations. Coupling
the membrane permeability with membrane elastic stress, tension, and
...
Red blood cells go through submicron slits many times during their
lifetime, and such process selects healthy, flexible red blood cells to
