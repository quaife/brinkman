...
file1 = 'BendMod0p55_Chip25_shax5p7_scL0p311_Conc0_Beta0_n1024_nbd1024_dt1en4_bmax0p55_bmin0p3025_eps0p04_a100_longchoke_rand.bin';
file2 = 'BendMod0p55_Chip25_shax5p7_scL0p311_Conc0_Beta0_n1024_nbd1024_dt1en4_bmax0p55_bmin0p3025_eps0p04_a100_longchoke_rand_contFromEnd.bin';
% Merge files
[posx,posy,conc,ea,el,time,xvel,yvel,ten] = loadFile(file1);
[posx2,posy2,conc2,ea2,el2,time2,xvel2,yvel2,ten2] = loadFile(file2);

% Runs that restarted from t - 500
% posx1 = posx1(:,:,1:end-5001); 
% posy1 = posy1(:,:,1:end-5001);
% conc1 = conc1(:,:,1:end-5001);
% ea1 = ea1(1:end-5001);
% el1 = el1(1:end-5001);
% time1 = time1(1:end-5001);
% xvel1 = xvel1(:,:,1:end-5001);
% yvel1 = yvel1(:,:,1:end-5001);
% ten1 = ten1(:,:,1:end-5001);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
file3 = 'BendMod0p55_Chip25_shax5p7_scL0p311_Conc0_Beta0_n1024_nbd1024_dt1en4_bmax0p55_bmin0p3025_eps0p04_a100_longchoke_rand_contFromEndb.bin';
