...
\noindent
\comment{Abstract: it should be mentioned in the abstract that this is 2D
modelling. 2D simulations of vesicles are often perfectly fine to
...
\begin{itemize}
  ...
  \item \todo[inline]{BQ: Need to do larger extensional rates}
\end{itemize}
