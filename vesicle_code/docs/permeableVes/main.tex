...
\begin{abstract}
Lipid bilayer membranes have a native (albeit small) permeability for water molecules. 
As long as the bilayer structure stays intact without poration or rupture under load, 
the water influx/efflux  is
often assumed to be negligible in the absence of a gradient of osmotic stress. 
...
various flows and confinement configurations. Coupling the membrane permeability with membrane elastic stress, tension and mechanical stress 
in the framework of Helfrich free energy, we illustrate
that, in the absence of an osmotic stress gradient, a giant unilamellar vesicle may be significantly affected by water influx/efflux over a
sufficiently long time or under a strong confinement. 
Our simulation results quantify the conditions for water permeation to be negligible in terms of the timescales, flow strength of an external flow, and degree of confinement.
These results shed light on how microfluidic confinement can be utilized to estimate membrane permeability.
%
...
%$\beta = 10^{-6}$, 
$\beta\ll 1$,
the permeability velocity is much smaller than the force
...
%\todo[inline]{There might be some confusion regarding the value of $\beta$. The caption says one value and the text says another.}
