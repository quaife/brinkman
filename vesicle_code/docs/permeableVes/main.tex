...
Similar to~\cite{wu2015critical}, we consider a geometry whose width
gradually reduces from $16\mu$m to $1.6\mu$m and then immediately opens
again to $16\mu$m. We initialize a semi-permeable vesicle with $\alpha =
0.65$ that spans $10\mu$m of the total channel width. We start by
investigating whether the vesicle passes through the constriction with
different flow rates and permeability rates.
