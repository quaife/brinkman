...
\title{Vesicle-vesicle adhesion in linear flows: dynamics and rheology}% Force line breaks with \\
...
differing reduced areas.}
  \todo[inline]{Make black marks larger and reference that they come
  from Ghigliotti, Biben, Misbah 2010 JFM}
\end{figure}
\todo[inline]{Do the smaller reduced area doublets since the intrinsic
viscosity seemed to increase as the reduced area was decresed further}
\todo[inline]{Decompose the red curve as the intrinsic viscosity due to
adhesion and due to the bending/tension}
