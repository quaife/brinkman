...
\begin{figure}[htp]
  \includegraphics[width=0.45\textwidth]{figs/adR4em1adS7em1_ra070_inclinationAngle.pdf}
  \todo[inline]{need a plot describing what the inclination angle
  is}
  \caption{\label{fig:extensionalInclinationAngle} The inclination angle
  of a doublet formed by vesicles of reduced area $0.70$ submerged in an
  extensional flow with an extensional rate of $\chi$.}
\end{figure}
