...
%    \subfigimg[width=\columnwidth,trim ={5cm .5cm 2cm .5cm},clip]{(c)}{figures/leftSep.pdf}
  ...
  initial lipid distribution. The preferred lipid distribution has the
  stiff region passing through the contraction before the floppy
  region.}
\end{figure}
...
%  \subfigimg[width=\columnwidth]{(b)}{figures/bendingEngMC45.pdf}
  \caption{\label{fig:bendingSC_contracting} The bending energy of (a) a
  single-component vesicle, and (b) a multicomponent vesicle whose
  boundary is 45\% floppy passing through a contracting geometry. The
  vesicle shape at different locations are included. We can clearly see
  that the sudden increases and decreases in the bending energy are due
  to transitions between lower energy and higher energy shapes.}
\end{figure}
