...
\begin{figure}
  \includegraphics[height=0.27\textwidth]{figs/shear_adR4em1Chi1e0_ra-090.pdf}
  \includegraphics[height=0.27\textwidth]{figs/shear_adR4em1_ra090_phaseDiagram.pdf}
  \includegraphics[height=0.27\textwidth]{figs/shear_adR1em1_ra090_phaseDiagram.pdf}
  ...
  $\mathcal{H}=0.1$ and $\mathcal{H}=1.0$.  {\em Center and Right}:
  Phase diagram of vesicle hydrodynamics in a shear flow with $\delta =
  0.4$ (center) and $\delta = 0.1$ (right) with reduced area  $\Delta A
  = 0.9$. The critical Hamaker constant $\mathcal{H}$ for binding of two
  vesicles in a shear flow depends on the shear rate $\chi$.  For a
  doublet to form, lower separation distances require a stronger Hamaker
  constants at a given shear rate.}
\end{figure}
