...
division~\cite{FredChang}, and
apoptosis~\cite{marchetti1996mitochondrial}.
%osmotic flow across the membrane.
While osmotic stress  is more effective and efficient than mechanical
stress in contributing to change in cellular volume, our results suggest
that the water permeation due to the capillary pressure may be
non-negligible over long times or under strong confinement in these
physiological processes. Currently we are examining the combined effects
of osmotic and mechanical stresses in the small Peclet number limit,
which is relevant to cellular migration in the presence of both
confinement and a solute gradient~\cite{StrokaJiangChenEtAl2014_Cell}
and has been studied numerically by Jaeger {\em et
