...
\begin{figure}[htp]
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[height=6cm]{figs/adhesionPotential.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[height=6cm]{figs/configCartoon.pdf}
  \end{minipage}
  \caption{\label{fig:adhesionModel} {\em Left}: The adhesion potential
  $\phi(z)$ in Equation~\eqref{eq:adhesion_potential}.  Distances in the
  green region are repulsive and distances in the blue region are
  ...
  point marked in with a red dot is repelled by the green region and
  attracted to the blue region.  The net forces are plotted with the
  black arrows.}
\end{figure}
...
\end{figure}
\todo[inline]{Indicate the shear flow in the right most plot.}
