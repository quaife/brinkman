...
\textcolor{blue}{
  where we use the parameter value $\delta = 0.3$ (a little less than
  1~$\mu$m).
}
...
\textcolor{blue}{
with an effective radius of about $4~\mu$m
}
...
\textcolor{blue}{
The width of the stenosis starts at $21.6~\mu$m and narrows to
$4.4~\mu$m. 
}
