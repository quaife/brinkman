...
\centering
\fbox{
\includegraphics[height=0.2\textwidth,trim={10cm 0cm 10cm 0cm},clip]    {figs/relaxationManyVesInitialCondition.png}
}
\fbox{
\includegraphics[height=0.2\textwidth]{figs/relaxationManyVesTension.png}
}
\fbox{
\includegraphics[height=0.2\textwidth]{figs/relaxationManyVesAdhesion.png}
}
