...
\begin{figure}[htp]
  \includegraphics[height = 0.2\textwidth,trim={1cm 0cm 1cm 0cm},clip]
    {figs/extensional_displacement0_adS7em1_image01.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement0_adS7em1_image02.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement0_adS7em1_image03.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement0_adS7em1_image04.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement0_adS7em1_image05.png} \\

  \includegraphics[height = 0.2\textwidth,trim={1cm 0cm 1cm 0cm},clip]
    {figs/extensional_displacement2em2_adS7em1_image01.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement2em2_adS7em1_image02.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement2em2_adS7em1_image03.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement2em2_adS7em1_image04.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement2em2_adS7em1_image05.png} \\

  \includegraphics[height = 0.2\textwidth,trim={1cm 0cm 1cm 0cm},clip]
    {figs/extensional_displacement1em1_adS7em1_image01.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement1em1_adS7em1_image02.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement1em1_adS7em1_image03.png}
  \includegraphics[height = 0.2\textwidth,trim={4cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement1em1_adS7em1_image04.png}
  \includegraphics[height = 0.2\textwidth,trim={3.5cm 0cm 4cm 0cm},clip]
    {figs/extensional_displacement1em1_adS7em1_image05.png} \\
...
a single vesicle may remain steady and symmetric for low extensional rate $\chi$.
For sufficiently large extensional rate $\chi$ the vesicle may undergo asymmetric deformation \cite{KantslerSegreSteinberg2008_PRL,Narsimhan2014_JFM,DahlNarsimhanGouveia2016_SoftMatt}. 
...
(filled squares in Figure \ref{fig:extensionalNonsymmetric}).

As the initial vertical displacement $\triangle y$ increases, we observe similar vesicle dynamics only at the beginning 
when the right vesicle moves towards the left vesicle as the left vesicle is pushed to the left of the stagnation point. 
As both vesicles come to close vicinity of the stagnation point, the diverging flow pulls the
right vesicle (elevated with a small vertical displacement at $t=0$) further away, causing rotation of both vesicles. 
...
For sufficiently strong adhesion (such as ${\cal H}=0.7$ for first three rows in Figure \ref{fig:extensionalNonsymmetric}),
...
center. Once vesicles move along the diverging stream, their hydrodynamics is dominated by the strong straining flow in the far-field.
...
In Figures~\ref{fig:extensional1}, snapshots of a fluid trap containing a
...
configuration, as shown in Figures~\ref{fig:extensional1}.  
%
The final configurations in Figures~\ref{fig:extensional1}
are similar to those at $t=100$ in Figure~\ref{fig:extensionalNonsymmetric}.
%
We also
...
Table~\ref{tbl:aspectRatio}.  

Since the effective aspect ratio is
...
shear rate, indicating that the reported Hamaker constants, the dynamics
of the doublet differ from that of a Jeffery orbit.}
\end{table}
\todo[inline]{period results with $\delta$ = 0.1, 0.2, 0.3, 0.4 so that
we can simply say how it affects the period}
...
\begin{figure}
  ...
  \end{tabular}
%  \includegraphics[height=0.34\textwidth]{figs/shear_adR4em1Chi5em1_ra090.pdf}
%  \includegraphics[height=0.34\textwidth]{figs/shear_adR4em1Chi5em1_ra090_period.pdf}
