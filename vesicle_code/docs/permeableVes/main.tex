...
flux. In Figure~\ref{fig:stenosisTensionAndFux}, the tension at location
$x=20$ and the flux at location $x=30$ are plotted with respect to
arclength. The value of $\theta=0$ corresponds to the nose of the
vesicle.
\begin{figure}[htp]
  \ifTikz
...
\begin{figure}[htp]
  \centering
  \ifTikz
  \scalebox{0.5}{\input{figures/stenosisTension09.tikz}}
  \scalebox{0.5}{\input{figures/stenosisFlux10.tikz}}
  \fi
  \caption{\label{fig:stenosisTensionAndFlux} The tension (left) and
  flux (right) of the semi-permeable (red) and impermeable (dashed blue)
  vesicles in Figure~\ref{fig:stenosisShape} at locations $x=20$ and
  $x=30$. The point $\theta=0$ corresponds to the right-most point of
  the vesicle.}
\end{figure}
