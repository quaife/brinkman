...
\begin{figure}[htp]
  ...
  definition of the inclination angle of a vesicle doublet at the center of an extensional flow.  
  An inclination angle of $\pi$
...
With the inclination angle fixed at $\theta=\pi/2$,
...
%
At low extensional
rates, we expect the $\theta=\pi/2$ doublet to stay intact at the fluid
...
= 0.8$ is split with a critical extensional rate $\chi_c \sim 0.1$
