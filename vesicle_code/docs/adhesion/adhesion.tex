...
Starting from a doublet inclination angle $\theta=\pi/2$, 
the vesicle doublet slowly begins to rotate around $t\sim 265$
(see the left plot of
Figure~\ref{fig:extensionalInclinationAngle}).  We notice that the net force on each vesicle is almost 
