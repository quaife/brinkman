...
Thus a reasonable choice for $(m,n)$ between two coarse-grained membrane patches
 ...
 Large value of $m$ corresponds to a sharp increase in repulsion force as two objects are within the separation distance $\delta$.
 ...
 and found very little difference in both the dynamic evolution and equilibrium configuration between $(m,n)=(8,6)$ and $(m,n)=(4,2)$.
...
$0.6$ with $H=5$ \todo[inline]{Is this really the Hamaker constant?
...
\begin{figure}[htp]
  ...
  $H=0.7$ and adhesion length scale $\delta=0.4$.  For small extensional
  rates, the doublet structure is not broken (blue marks), while at
  large extensional rates, the doublet is broken (red marks).}
\end{figure}
...
\todo[inline]{Plot of the final inclination angle of doublets that
survive the extensional rate}
...
\begin{figure}[htp]
  ...
  $\chi=0.5$.}
  \todo[inline]{Superimpose the background velocity on the leftmost plot
  to indicate the shearing motion}
\end{figure}
