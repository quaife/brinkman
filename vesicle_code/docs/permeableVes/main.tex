...
\todo[inline]{redo this paragraph}
...
\begin{figure}[htp]
  ...
  %\fi
  \includegraphics[width=0.9\linewidth]{figures/shearPhaseDiagramRA2.pdf}
...
\begin{figure}[htp]
  ...
  the final vesicle shape is either an asymmetric parachute or bullet
  (pink region) or a axisymmetric slipper (yellow region).}
\end{figure}
...
%  \includegraphics[width=0.8\linewidth]{figures/parabolicPhaseDiagram.pdf}
  ...
  \todo[inline]{Put snapshots of configuration in the geometry}
\end{figure}
