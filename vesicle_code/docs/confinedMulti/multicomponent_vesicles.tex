...
\end{align}
\textcolor{blue}{
where the fluid velocity $\UU$ on the solid wall $\Gamma$ is defined in
...
case. Since the floppy bending modulus is ten-times smaller than the
stiff case, this indicates that the curvature of the floppy vesicle is
about $\sqrt{10}$-times larger than the stiff case. This additional
