...
the bending energy. Also, since the stiff single-component vesicle
reaches a steady-state shape earlier, its tension and bending energies
remain nearly constant from $x=0$ until the end of the stenosis.
Regarding the multicomponent vesicle, the phase energy has sudden
decreases that correspond to the lipid phase coarsening. Note that this
coarsening only occurs when the vesicle is not in the stenosis. Finally,
when coarsening does occur, this results in a sudden change in the
bending and tension energies, but these energies almost instantly return
to their previous values once coarsening is complete.
