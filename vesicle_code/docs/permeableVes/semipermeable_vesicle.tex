...
\todo[inline]{Somehow emphasize that we are getting second-order}

\todo[inline]{Have validated that it's second order in other work ...}
...
\begin{figure*}[htp]
  ...
  vesicle in the short geometry in (a). (f) The reduced area of the
  semipermeable vesicles in the geometries in (a) and (b) as a function
  of the vesicles' center of mass. In (e) and (f), the x-axis is scaled
  ...
  the constriction. The colored vesicles show the tension distribution
...
outlet so that the residency time of the vesicle in the stenosis channel
...
and~\ref{fig:stenosisComposite}(g) show that the vesicle deflates from
...
contraction. When the vesicle is near the neck, simulations show that
the water efflux is in the front and rear of vesicle while most water
influx is in the middle. The tension distribution along the vesicle as
...
\begin{figure}[hbp]
  ...
  the upper x-axis is time. (d) The vesicle tension in N/m. (e) The
  maximum vesicle tension.}
...
Figure~\ref{fig:contractingComposite2}(e). We see that the vesicle
...
when the vesicle has the largest area.
