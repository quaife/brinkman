...
points = [0,15,30,45,60,75];
%points = [0.05,0.15,0.2,0.28,0.31,0.34,0.4,0.5];

a = find(time1>=points(2));
b = find(time1>=points(3));
c = find(time1>=points(4));
d = find(time1>=points(5));
e = find(time1>=points(6));
% f = find(time1>=0.34);
% g = find(time1>=0.4);
% h = find(time1>=0.5);
k = [1,a(1),b(1),c(1),d(1),e(1)];
