...
have been observed to contain a vast array of proteins and different lipid species, that phase-separate and form domains or rafts, resulting in spatial variations in material properties such as bending stiffness \cite{}. Synthetic multicomponent vesicles, self-enclosed lipid bilayer membranes composed of different lipid species, have been used to study the rich patterns and accompanying morphologies which emerge from elastic heterogeneity in the membrane.  In a quiescent environment, inhomogeneity in a vesicle membrane bending stiffness may give rise to change in vesicle morphology \cite{Lowengrub2009_PRE}, closely related to cellular budding and fission processes \cite{Rauch2000_BriophysJ} as well as in membrane adhesion and fusion \cite{Takeda2003_PNAS}. 

Under a linear shear flow, a multicomponent vesicle exhibits exotic dynamics in both shape and membrane composition \cite{Liu2017_SoftMatter,Gera2018_SoftMatter,Gera2022_JFM}. The vesicle hydrodynamics is characterized by parameters such as the capillary number, reduced volume, and
