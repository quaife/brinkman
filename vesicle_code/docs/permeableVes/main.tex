...
Without aquaporins or other membrane channels that promotes water permeability, the intrinsic water permeability is known to depend on the temperature \cite{}, solvent ph \cite{}, and the hydration  energy of the membrane \cite{}. In this work we focus on the intrinsic water permeability and study the hydrodynamics of a semipermeable membrane. Specifically we focus on the water permeability due to jump in normal membrane traction.
