...
\begin{figure*}[hbp]
  ...
  semipermeable vesicles with $\beta = 5 \times 10^{-7}$ submerged in a
  fluid with no background flow flow. Time goes from left to right. The
...
$Ca_E=\dot{\gamma}\tau$, where $\tau$ is the characteristic time scale in the system (see Supplementary Material) and
...
\begin{figure*}[htp]
  \centering
  \ifTikz
    \input{figures/stenosisTensions.tikz}
  \else
    \includegraphics{figures/stenosisTensions.pdf}
  \fi
