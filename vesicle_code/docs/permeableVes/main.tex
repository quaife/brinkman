...
\begin{figure*}[htp]
  ...
  semipermeable vesicle in a Poiseuille flow. \todo[inline]{Fix font
  size of block (d)}}
\end{figure*}
...
\begin{figure}[hbp]
  ...
  vesicle configurations have the largest tension.\todo[inline]{Make the
  time steps equispaced and the values of $x$ non-uniform. Reverse their
  orders between to and bottom.}}
\end{figure}
