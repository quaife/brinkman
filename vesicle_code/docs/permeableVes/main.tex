...
\begin{abstract}
Lipid bilayer membranes have a native (albeit small) permeability for water molecules. Under an external load 
 the water influx/efflux is often assumed  negligible in the absence of osmolarity, provided 
that the lipid bilayer membrane remains intact (no poration or rupture),. 
%
...
from an external flow deforming a vesicle in free space or pushing the vesicle through a confinement. Coupling the 
