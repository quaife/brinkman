...
doublet may form as they approach each other in a planar shear flow
provided that the adhesion strength is sufficient large at a given
vesicle reduced area. Once a doublet the effective shear viscosity of a
dilute suspension of vesicle doublets is found to be a function of both
reduced area and the adhesion strength.  Results from these numerical
studies and analysis shed light on the hydrodynamic effects of adhesive
...
\begin{figure}[htp]
  ...
  flow.  The reduced area is $\Delta A = 0.90$, the Hamaker constant is
  $\mathcal{H}=0.7$, the adhesion length scale is $\delta = 0.4$, and
...
\begin{figure}
  ...
  A=0.90$ and $\delta =0.4$,  the critical vdW potential strength
...
Hamakar constant $\mathcal{H}=0.7$, which corresponds to $\sim 1$ $\mu
J/m^2$.  These conditions are quite realizable in micrifulidic
experiments, and we hope that our simulations might inspire microfluidic
experiments.
