...
The exponents $(m,n)$ depend on the geometry and the molecular details
...
and the tension operator $\TT[\xx](\sigma) = (\sigma \xx_s)_s$, and
using IMEX-Euler, the no-slip boundary results in the time stepping
method
\begin{align*}
