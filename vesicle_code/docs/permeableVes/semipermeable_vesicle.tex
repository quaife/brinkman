...
%two-dimensional vesicle hydrodynamics revealed salient features that are also observed in three-dimensions, such as a vesicle in shear flow \cite{GhigliottiBibenMisbah2020_JFM,AgarwalBiros2020_PRF}. Even though quantitative connection to  experimental observation requires some adjustment, results from simulating two-dimensional vesicle hydrodynamics can be insightful for the full three-dimensional simulations of a semipermeable vesicle that we are currently undertaking.
%}
%
