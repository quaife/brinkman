...
or a nano particle).  Adhesion between a vesicle and a substrate has been extensively studied with 
more focuses on the static equilibrium
shapes~\cite{Seifert1990_PRA, ShiFengGao2006_ActaMechSin,
LinFreund2007_IntJSolidsStructures, GruhnFrankeDimova2007_Langmuir,das2008adhesion, zhang2009phase,SteinkuhlerAgudo-Canalejo2016_BJ}
...
it is reported that 
%such complicated electrostatic component in 
...
%%
%%move this somewhere else Jan30YNY
%Such adhesive
...
formation due to the van der Waals' attraction. For the adhesive interaction between two lipid bilayer membranes in buffer solutions, a typical range for the
energy density is between $1$ to $10$ $\mu J/m^2$, 
%
%they reported
%an energy density of $\sim 10$  $\mu J/m^2$ and a separation distance of $\sim 3$  $nm$.
%
% membrane-membrane
...
%to 
%
%an adhesion energy density around $1$ $\mu J/m^2$,
similar to the adhesion energy density of $3$  $\mu J/m^2$ between two RBCs \cite{FlormannAouane2017_SciReports}.
For adhesion interaction between a vesicle and a substrate  \cite{GruhnFrankeDimova2007_Langmuir}, 
the boundary between weak and strong adhesion is around $1$ $\mu J/m^2$:
the vesicle-substrate interaction is ``strong" when the adhesion energy density is larger than $1$ $\mu J/m^2$ and ``weak" when the energy
density is less than $1$ $\mu J/m^2$.
%
%weak adhesion regime 
%
%Gruhn {\it et al.} made a distinction between strong and weak adhesion regimes for a vesicle adhering on a substrate.
%Strong adhesion regime when the adhesion energy density is greater than $1$ $\mu J/m^2$,
%while weak adhesion regime when adhesion energy density is less than $1$ $\mu J/m^2$.
%
In this work we use the ratio of the adhesion energy to the bending energy for classification of adhesion strength:
The ratio of total adhesion
energy to the bending energy (bending rigidity of lipid
...
the weak adhesion (adhesion energy/bending energy $\ll 1$) and strong adhesion (adhesion energy/bending energy $\gg 1$)
...
The equilibration of vesicle membranes in the strong adhesion regime
have been well studied and documented
(see~\cite{RamachandranAndersonLealIsraelachvili2010_Langmuir,SteinkuhlerAgudo-Canalejo2016_BJ,FlormannAouane2017_SciReports} and
...
result in the vesicles separating.  For extensional rates and reduced
areas that result in a fluid trap, the initial configuration of the
vesicles have the diverging stream direction parallel to the vesicles'
short axis.  Since the stable configuration of two vesicles in an
extensional flow has the converging direction parallel to the vesicles'
short axis, we expect the vesicles to align themselves with the long
axis parallel to the diverging direction.  We observe in
...
diverging direction.  In the left plot of
Figure~\ref{fig:extensionalPhaseDiagram}, the size of the round dots are
scaled the final inclination angle as defined in the right plot.  At
smaller extensional rates, the vesicles comes closer to aligning their
long axis with the diverging direction.  The inclination angle is
...
Next we conduct a numerical experiment where a vesicle doublet is placed at the center of a fluid trap, which 
can be actively controlled in microfluidic channel so that fluid trap center is effectively the stagnation point of an extensional flow characterized by a extensional flow rate.
...
probe the adhesion strength between membranes. 
For a pair of $\mu m$-sized vesicles with a bending rigidity of $\sim 10^{-19}$ $J$, an extensional flow rate of $0.5$ $s^{-1}$ is expected to separate a vesicle
doublet with reduced area of $0.8$ and a Hamakar constant ${\cal H}=0.7$, which corresponds to $\sim 1$ $\mu J/m^2$. These conditions are quite realizable in micrifulidic
experiments, and we hope that our simulations might inspire microfluidic experiments.
%{\color{red} For adhesion energy blahblahblah, an extensional flow rate sososo is required to separate the doublet from our
