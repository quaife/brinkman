...
\title{Adhesion, hydrodynamics and rheology of vesicle doublets}
...
Figure~\ref{fig:relaxationManyVes} shows an initial condition of five vesicles
suspended inside of a larger vesicle, and the configuration and
streamlines at an intermediate configuration.  There is no imposed flow, so the
...
minimize the adhesion energy.   We also plot the tension (thrid) and
adhesion (fourth) of the final equilibrium configuration.  Both the
vesicle shape, tension, and adhesion qualitatively agree with our
doublet results.  In particular, the interior vesicles form a flat
