...
the vesicle configuration at \todo{some number} times. We observe that
the vesicle inflates towards a circular shape. 

\begin{figure}[htp]
%  \includegrahpics[width=0.3\textwidth]{figures/relaxationTime1.pdf}
%  \includegrahpics[width=0.3\textwidth]{figures/relaxationTime2.pdf}
%  \includegrahpics[width=0.3\textwidth]{figures/relaxationTime3.pdf}
