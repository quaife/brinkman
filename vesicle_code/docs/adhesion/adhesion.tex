...
We use Hamaker constants ranging from $0.1$ to $1$ times the bending
rigidity modulus.  In Appendix~\ref{sec:appendixA}, the adhesive force
at a point $\xx$ on vesicle $j$ is shown to be
\begin{align}
