...
\begin{figure}[htp]
  ...
  reduced area is $\Delta A = 0.75$, the extensional rate $\chi = ???$
  \todo[inline]{Yuan: Can you look and see what extensional rates you
  did for the runs that do not indicate the rate in the file name?} and
  the adhesion distance $\delta = 0.4$. }
  \end{figure}
...
To be consistent with simlulations in previous sections, the vesicles
have a length of $2\pi$ for all reduced areas.
