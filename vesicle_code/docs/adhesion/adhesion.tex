...
%  4)  latex apssamp.tex
%
\documentclass[aps,prl,showpacs,amsmath,amssymb]{revtex4-1}
...
tension, and possibly the stress}
...
\begin{align}
  ...
  \label{eqn:SLP}
\end{align}
\todo[inline]{Define $\rr$ and other variables in
equation~\eqref{eqn:SLP}}
...
significant increases the intrinsic viscosity at all reduced areas.  To
further characterize the effect of adhesion, in the right plot of
Figure~\ref{fig:shearIntrinsicViscosity} we decompose the intrinsic
viscosity into the contributions from the bending and tension, and the
contribution from the adhesion.  We see that the effect of the adhesion
on the intrinsic viscosity is largest for vesicles with small reduced
areas.
...
\begin{figure}[htp]
  ...
  for the bending and tension of the vesicles, and the contribution from
  the vesicle adhesion.}
\end{figure}
