...
doublet.  In Figure~\ref{fig:sflow_distance}(b), we plot the time
required for the doublet to make a complete revolution at a variety of
Hamaker constants and shear rates.  For a fixed Hamaker contant, as
expected, the period decreases for larger shear rates.  In addition, for
a fixed shear rate, the period decreases as the Hamaker constant
increases, but the period eventually plateaus.
