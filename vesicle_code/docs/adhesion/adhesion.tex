...
\includegraphics[keepaspectratio=true,scale=0.175]{figs/Dec18_EbEadh_vs_rA_adR0p2_adS502.jpeg}
  \caption{\label{fig:Dec18_vesicle_equilibrium1} Two vesicles of the same length, reduced area
  and bending rigidity ($\kappa=1$)  with $\mathcal{H}=5$ and $\delta=0.2$.  {\em Left}:
