...
Under what condition is this a good assumption? What is the dynamic consequence when permeable water flux/eflux affects the membrane hydrodynamics?
...
\begin{figure}[htp]
  \centering
   \includegraphics[width=0.475\textwidth]{figures/sketch_sample.png}
  \caption{\label{fig:sketch} Schematics showing the effects of semipermeability on vesicle hydrodynamics in various configurations.}
\end{figure}
\section*{Formulation}
...
At the beginning of the simulations a vesicle is initialized
above the center line $y=0$, and it migrates towards the center
