...
water molecules. Provided that the bilayer structure stays intact (no membrane poration or rupture) under load, the water influx/efflux is
...
\begin{figure*}[hbp]
  ...
  semipermeable vesicles with $\beta = 10^{-3}$ submerged in a fluid
...
\begin{figure*}[htp]
  ...
  to the simulations in part (a). \todo[inline]{Runs at smallest value
  of $\beta$ are being redone.}}
\end{figure*}
