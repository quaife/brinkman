...
%  \input{figures/ellipseVelocityNorms.tikz}
  ...
  \includegraphics[width=0.24\linewidth]{figures/ellipseVelocityNorms.pdf}
  \caption{\label{fig:vesVelocity} The velocity contributions due to
  force balance (blue) and permeability (red). The green line is the
  velocity of an impermeable vesicle with the same initial shape as the
  semi-permeable vesicle. The right-most plot is the maximum norm of
  each velocity contribution. The black lines correspond to the times
  reported in the other three plots.}
\end{figure*}
...
several locations along the constriction, and the corresponding tensions
are in Figure~\ref{fig:stenosisTension}.
\begin{figure}[htp]
  \ifTikz
  \scalebox{0.4}{\input{figures/stenosisShape1.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape2.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape3.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape4.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape5.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape6.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape7.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape8.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape9.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape10.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape11.tikz}}
  \scalebox{0.4}{\input{figures/stenosisShape12.tikz}}
  \fi
  \caption{\label{fig:stenosisShape} An impermeable (red) and
  semi-permeable (dashed blue) vesicle in a stenosed geometry (black).
  The vesicles' initial configuration are identical with reduced area
  $\nu = 0.65$. The semi-permeable vesicle deflates throughout the
...
\begin{figure}[htp]
  ...
  \fi
  \caption{\label{fig:stenosisBL} A stenosed semi-impermeable vesicle
  with reduced area 0.17. The initial reduced area is $0.20$. The bottom
  plot shows the velocity relative to the vesicle inside the square.
  The vesicle velocity in the square is nearly constant.}
\end{figure}
...
and diameter $5\mu$m (Figure~\_ref{fig:stenosisGeom}. We impose a
