...
irate = 30; % controls the speed of the visualization

if 1
  file = 'extensional2VesAData.bin';
%  file = '~/projects/brinkman/vesicle_code/results/extensional2Ves/adR4em1adS7em1Chi7em2_ra090_largerTol/extensional2VesData.bin';
  ax = [-4 4 -5 5];
