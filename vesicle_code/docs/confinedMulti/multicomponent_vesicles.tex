...
%\begin{figure}
  ...
  \caption{\label{fig:BLvelocities} The co-moving velocity field in the
  thin fluid layer between vesicles and the stenosis geometry. The
  vesicles are (a/b): single-component with $b(u) = 1$; (c/d):
