...
Under a linear shear flow, a multicomponent vesicle exhibits more exotic dynamics in both shape and membrane composition \cite{Smith2007_JChemPhys,Cox2015_Nonlinearity,Liu2017_SoftMatter,Gera2018_SoftMatter,Gera2022_JFM} than a single component vesicle \cite{Abreu2014_ACI}.
%
...
%
The vesicle hydrodynamics is characterized by parameters such as the capillary number, reduced volume, and
confinement ratio. Understanding these dynamics is critical to
understanding the biophysics of red blood cells (RBCs) in blood flow. For example, a
...
\begin{figure}[htp]
  \begin{minipage}{0.49\columnwidth}
    \centering
    \subfigimg[width=\textwidth]{(a)}{figures/SC_treading_velocity.pdf}
    \subfigimg[width=\textwidth]{(c)}{figures/SCp55_treading_velocity.pdf}
%    \subfigimg[width=\textwidth]{(c)}{figures/Fig11b1.pdf}
%    \subfigimg[width=\textwidth]{(e)}{figures/Fig11a.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.49\columnwidth}
    \centering
    \subfigimg[width=\textwidth]{(b)}{figures/SC_treading_configuration.pdf}
    \subfigimg[width=\textwidth]{(d)}{figures/SCp55_treading_configuration.pdf}
%    \subfigimg[width=\textwidth]{(d)}{figures/Fig11b2.pdf}
%    \subfigimg[width=\textwidth]{(f)}{figures/Fig11a2.pdf}
  \end{minipage}
  ...
  (c) single-component vesicle with $b = 0.55$, and (e) multicomponent
  vesicle. The reduced area is $\alpha = 0.4$ in all cases. (b/d/f) A
  corresponding vesicle shape with the Lagrangian points. }
\end{figure}
