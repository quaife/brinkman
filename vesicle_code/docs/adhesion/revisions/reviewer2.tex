...
comparison.}
\begin{itemize}
  \item For the extensional example, the reduced area has a large effect
  ...
  \item For the shear example, a smaller reduced area will increase the
    size of the contact area, and this will determine the critical
    Hamaker constant required to form a doublet.  However, to avoid
