...
negative tension in an extensional flow is consistent with the tension
for a vesicle with finite bending forces~\cite{Narsimhan2014_JFM} and
the speculation for a wrinkled membrane in the elongational
