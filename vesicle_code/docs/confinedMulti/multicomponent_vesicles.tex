...
\begin{figure}[htp]
  \centering
  \subfigimg[width=0.9\columnwidth,trim=0cm 6cm 28cm 1cm,clip=true]{(a)}{figures/TankTreadingFigs_composite_SC.pdf}
  \subfigimg[width=0.9\columnwidth,trim=0cm 6cm 28cm
  1cm,clip=true]{(b)}{figures/TankTreadingFigs_composite_SCp55.pdf}
  \subfigimg[width=0.9\columnwidth,trim=0cm 6cm 28cm
  1cm,clip=true]{(c)}{figures/TankTreadingFigs_composite_MCp5.pdf}
