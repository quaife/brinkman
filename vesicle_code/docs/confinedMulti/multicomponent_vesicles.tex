...
%  \subfigimg[width=0.9\linewidth, clip ]{(a)}{figures/oldbending.pdf} \\
  ...
  model in Equation~\eqref{eqn:linearBending}.  The color denotes the bending modulus $b(u)$.
  An instability is
...
-\sigma_s$ which is the Marangoni stress.
...
\begin{table}[h]
  ...
  \begin{tabular}{l|ccccc}
    ...
    Time  (dimensionless) & 2.32 & 2.30 & 2.29 & 2.26 & 2.24 \\
    \hline
  \end{tabular}
