...
viscosity both inside and outside the vesicles is the same; however, incorporating viscosity constrast is rather straightforward in our numerical algorithm. 
