...
vesicle. The initial lipid distribution of the multicomponent is random.
...
partially because these vesicles have a large reduced area. With the
current setup, an elliptical vesicle with reduced area greater than
...
To create more significant differences between the three cases, we
consider the same geometry, but for a vesicle with reduced area $\alpha
= 0.4$. Figure~\ref{fig:RA4} shows six time steps of a (a) stiff
single-component, (b) floppy single-component, and (c) multicomponent
vesicle. We first consider the three different energies---bending,
...
vesicles do not have a phase energy. A few general trends can
immediately be seen. First, as the vesicle enters the stenosis, there
are sharp jumps in both the tension and bending energies, as expected.
Next, the multicomponent vesicles only coarsen when the vesicle is not
in the stenosis. Finally, when coarsening does occur, there are rapid
changes in the tension energy.
